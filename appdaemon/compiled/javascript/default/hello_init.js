$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-label"] = new basedisplay("default-label", "", "default", {'css': {}, 'static_icons': [], 'icons': [], 'widget_type': 'basedisplay', 'static_css': {'widget_style': 'background-color: #444;', 'title_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'value_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'unit_style': '', 'container_style': ''}, 'fields': {'title2': '', 'value': 'Hello World', 'title': '', 'state_text': '', 'unit': ''}, 'namespace': 'default'})
